...
type DeleteInsuranceModalProps = {
  open: boolean
...
export function DeleteInsuranceModal({ open, record, onClose, onConfirm }: DeleteInsuranceModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title={t('insurance.delete.title')} size="sm">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-400">
          {t('insurance.delete.message', { name: displayName })}
        </p>
