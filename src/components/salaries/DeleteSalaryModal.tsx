...
export function DeleteSalaryModal({ open, record, onClose, onConfirm }: DeleteSalaryModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title={t('salaries.delete.title')} size="sm">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-400">
          {t('salaries.delete.message', { name: displayName })}
        </p>
