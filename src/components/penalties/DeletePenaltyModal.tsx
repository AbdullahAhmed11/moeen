...
export function DeletePenaltyModal({ open, record, onClose, onConfirm }: DeletePenaltyModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title={t('penalties.delete.title')} size="sm">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-400">
          {t('penalties.delete.message', { name: displayName })}
        </p>
