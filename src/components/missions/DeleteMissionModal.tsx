...
export function DeleteMissionModal({ open, record, onClose, onConfirm }: DeleteMissionModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title={t('missions.delete.title')} size="sm">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-400">
          {t('missions.delete.message', { name: displayName })}
        </p>
